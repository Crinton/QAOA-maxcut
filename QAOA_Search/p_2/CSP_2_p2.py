...
def Qaoa2Stat(gamma_1,beta_1,gamma_2,beta_2,t):
    ...
    A = _Rx(0,4,beta_2)*_Rx(1,4,beta_2)*_Rx(2,4,beta_2)*_Rx(3,4,beta_2) \
        *_Rz(0,4,gamma_2)*_Rz(1,4,gamma_2)*_Rz(2,4,gamma_2)*_Rz(3,4,gamma_2) \
        *(_Rzz(0,1,4,-gamma_2))*_Rzz(2,3,4,gamma_2)*_Rzz(0,2,4,gamma_2) \
...
#-------------------读取N参数
parser = argparse.ArgumentParser(description='CSP-问题2-p=2')
