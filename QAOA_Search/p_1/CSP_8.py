...
def QaoaGetPara(gamma,beta,t,isOutStat = False):
    ...
    if isOutStat:
        return B
    H_C = np.kron(z,I(3)) + np.kron(np.kron(I(1),z),I(2))   \
...
if __name__ == "__main__":
    ...
    row = table.loc[row_idx,:] # E_max对应列
    ...
    plt.savefig("heatmap-CSP_8.jpg", bbox_inches = "tight")
    # 创建狄拉克符号的基态字符串列表
    ...
    plt.savefig("bar-CSP_8.jpg", bbox_inches = "tight")
