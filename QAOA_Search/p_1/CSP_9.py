...
def QaoaGetPara(gamma,beta,t,isOutStat = False):
    ...
    A = _Rx(0,4,beta)*_Rx(1,4,beta)*_Rx(2,4,beta)*_Rx(3,4,beta) \
        *_Rz(0,4,gamma)*_Rz(2,4,gamma)*_Rz(3,4,-gamma) \
        *_Rzz(1,3,4,gamma) \
...
if __name__ == "__main__":
    ...
    plt.savefig("heatmap-CSP_9.jpg", bbox_inches = "tight")
    # 创建狄拉克符号的基态字符串列表
    ...
    plt.savefig("bar-CSP_9.jpg", bbox_inches = "tight")
